...
mod benchmarks {
	...
	#[benchmark]
	fn remark() -> Result<(), BenchmarkError> {
		let mut remarks = Vec::new();

		for _ in 0..T::MaxRemarksPerCall::get() {
...
// 		}
//
// 		let remarks = BoundedVec::<T::Remark,
// T::MaxRemarksPerCall>::try_from(remarks).expect("can build remarks");
//
// 		let caller: T::AccountId = account("acc_0", 0, 0);
// 		let call: <T as Config>::RuntimeCall = frame_system::Call::remark { remark:
// vec![] }.into(); 	}: remark(RawOrigin::Signed(caller), remarks.clone(),
// Box::new(call.clone())) 	verify {
...
// }
//
// impl_benchmark_test_suite!(Pallet, crate::mock::new_test_ext(),
// crate::mock::Runtime);
